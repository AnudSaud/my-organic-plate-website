...
<body class="home">
        ...
        <section>
            <div>
            <img src="images\shop3.png" alt="" style="width: 1530px; height: 700px; overflow: hidden;" >
            </div>
        </section>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2 class="text">Popular organic foods of the Month</h2>
                    <p class="text">Easiest way to order your favourite food among these top organic dishes</p>
                </div>
                <div class="row">
						<?php

						$query_res = mysqli_query($db, "SELECT * FROM dishes WHERE rs_id IN (12, 13, 14, 15) AND d_id IN (127, 129, 134, 137, 120, 122, 123, 141, 144)"); 
        ...
        <section>
            <div>
            <img src="images\frontimage6.jpeg" alt="" width="1530px" >
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4 class="fr">Featured Shops</h4> </div>
                    </div>
                    <div class="col-sm-8">
