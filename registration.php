...
<div style=" background-image: url('images/img/pimg.jpg');" >
         ...
         <div class="page-wrapper" >
               ...
               <div class="container"style="background-color: rgb(48, 0, 57);">
                  <ul>
            ...
            <section class="contact-page inner-page" style="background-color: rgb(48, 0, 57);">
               <div class="container ">
                  <div class="row ">
                     <div class="col-md-12">
                        <div class="widget" >
